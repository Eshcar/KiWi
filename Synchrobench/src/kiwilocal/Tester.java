...
public class Tester implements Runnable
{
	...
	public static void test() throws Exception
	{
		...
		for (int i = 0; i < threads.length; ++i)
			threads[i] = new Thread(new kiwi.Tester());
	...
	public static void main(String[] args) throws Exception
	{
		...
		else
		{
			...
			//System.out.println("Keys: " + keys + ", dups: " + dups + ", avg.: " + (double)dups / keys);
			//System.out.println("Put max: " + kMap.kiwi.putMax.get() + ", avg.: " + (double)kMap.kiwi.putTime.get() / kMap.kiwi.putCount.get());
		}
	}
}
